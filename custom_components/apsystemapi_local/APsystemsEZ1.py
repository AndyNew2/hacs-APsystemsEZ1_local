...
class APsystemsEZ1M:
    ...
    # def activate_max_power_rewrite(self) -> None:
    #    """Activate the rewrite of the max power value, which is needed for newer firmware versions > 1.10.x that do not store the max power value anymore."""
    #    self.needs_rewrite_max_power = True
